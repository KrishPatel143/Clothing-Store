  ...
  return (
    <footer className="border-t border-ink/10 mt-20 bg-parchment/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 grid gap-10 md:grid-cols-3">
        <div>
          <div className="font-display text-2xl mb-3">MIRA<span className="text-clay">.</span></div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-ink-soft">
            ...
            <li><Link to="/shop?category=kids" className="hover:text-clay">Kids</Link></li>
      ...
      <div className="text-center text-xs text-ink-soft/60 pb-6">
        © {new Date().getFullYear()} MIRA. Size recommendations are estimates — always check the chart.
      </div>
    </footer>
  );
}
